...
| 6 | 018 | Quitar el NIF y la dirección del titular de los textos legales | P1 | S | LOW | 011 | DONE — **en producción** (2026-09-23): `main` = `3e80609`; verificado en vorama.es (privacidad y aviso legal solo con nombre y teléfono, "Última actualización: 23 de septiembre de 2026"). El historial de git sigue conteniendo esos datos (ver "Acciones del operador") |
