...
| Hecho (2026-09-23) | Historial de git reescrito (NIF y dirección → `[NIF eliminado]` / `[dirección eliminada]` en las versiones antiguas de los textos legales; force push con lease; 0 objetos con datos en GitHub `main` y en la copia local; identificadores de commit actualizados en `plans/`). **Riesgo residual aceptado por el titular (opción C, 2026-09-23)**: no pedirá la purga al soporte de GitHub; los commits antiguos siguen accesibles por su identificador desde la página de actividad del repo (force push `9825d18`→`4978e43`). Comprobado fuera de GitHub: Software Heritage no tiene el repo; Wayback Machine solo tiene la portada de 2025, sin los datos. Alternativas descartadas: recrear el repo (gratis, definitiva) o GitHub Pro + repo privado. Pendiente del titular: borrar `C:\WebSites\_copias\vorama-astro-historial-original-2026-09-23.bundle` cuando quiera | 018 |
